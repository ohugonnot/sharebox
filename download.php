...
.grid-card { position:relative; aspect-ratio:2/3; border-radius:var(--radius-md); overflow:hidden; cursor:pointer; text-decoration:none; color:var(--text-primary); transition:transform .18s,box-shadow .18s; animation:fadeScale .25s ease both; border:1px solid rgba(255,255,255,.06); display:flex; flex-direction:column; }
.grid-card:hover { transform:translateY(-4px) scale(1.02); box-shadow:0 12px 32px rgba(0,0,0,.5); border-color:rgba(240,160,48,.2); }
.grid-card-bg { flex:1; min-height:0; display:flex; align-items:center; justify-content:center; background-size:cover; background-position:center top; transition:background-image .3s; }
...
.grid-card-label { flex-shrink:0; height:3.2rem; display:flex; align-items:center; justify-content:center; padding:0 .5rem; background:rgba(0,0,0,.72); backdrop-filter:blur(4px); text-align:center; }
